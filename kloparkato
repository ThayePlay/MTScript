-- M&T Gui V1.5.3, credits to MellGuips#9963

local colorSettings =
{
    ["Main"] = {
        ["HeaderColor"] = Color3.fromRGB(196, 0, 0),
        ["HeaderShadingColor"] = Color3.fromRGB(160, 0, 0),
        ["HeaderTextColor"] = Color3.fromRGB(0, 0, 0),
        ["MainBackgroundColor"] = Color3.fromRGB(40, 40, 40),
        ["InfoScrollingFrameBgColor"] = Color3.fromRGB(0, 0, 0),
        ["ScrollBarImageColor"] = Color3.fromRGB(196, 0, 0)
    },
    ["RemoteButtons"] = {
        ["BorderColor"] = Color3.fromRGB(196, 0, 0),
...
Code.Text = "Thanks for using M&T! :D"
...
CodeComment.Text = "-- Script generated by M&T, made by MellGuips#9963 & Thaye#0916"
